...
<cfcomponent output="false" persistent="false" accessors="true">
	...
	<cffunction name="editprofile" returntype="any" output="false">
		...
		<cfif isDefined("FORM.formSubmit") and not isDefined("URL.FormRetry")>
			...
			<cfif Variables.UserEditProfile EQ 1>
				...
				<cflocation addtoken="true" url="/plugins/#HTMLEditFormat(rc.pc.getPackage())#/index.cfm?#HTMLEditFormat(rc.pc.getPackage())#action=public:main.viewavailableevents&UserProfileUpdateSuccessfull=True">
			<cfelse>
				<cflocation addtoken="true" url="/plugins/#HTMLEditFormat(rc.pc.getPackage())#/index.cfm">
			</cfif>
	...
	<cffunction name="lostpassword" returntype="any" output="false">
		...
		<cfif isDefined("FORM.formSubmit") and not isDefined("form.formSendTemporaryPassword")>
			...
			<cflocation addtoken="true" url="/plugins/#HTMLEditFormat(rc.pc.getPackage())#/index.cfm?#HTMLEditFormat(rc.pc.getPackage())#action=public:main.viewavailableevents&UserAccountPasswordVerify=True">
		<cfelseif isDefined("FORM.formSubmit") and isDefined("FORM.formSendTemporaryPassword")>
			...
			<cfif FORM.formSubmit EQ "true" and FORM.formSendTemporaryPassword EQ "true">
				<cfif FORM.SendTempPassword EQ 1>
					...
					<cflocation addtoken="true" url="/plugins/#HTMLEditFormat(rc.pc.getPackage())#/index.cfm?#HTMLEditFormat(rc.pc.getPackage())#action=public:main.viewavailableevents&UserAccountPasswordSent=True">
				<cfelse>
					<cflocation addtoken="true" url="/plugins/#HTMLEditFormat(rc.pc.getPackage())#/index.cfm?#HTMLEditFormat(rc.pc.getPackage())#action=public:main.viewavailableevents&UserAccountNotModified=True">
				</cfif>
			</cfif>
		...
		<cfif isDefined("FORM.formSubmit") and isDefined("form.UserID")>
			...
			<cfif Application.serviceFactory.getBean("utility").checkBCryptHash(FORM.oldPassword,getAccountPassword.password) EQ true OR (Hash(form.oldPassword) eq getAccountPassword.password)>
				...
				<cftry>
					...
					<cflocation addtoken="true" url="/plugins/#HTMLEditFormat(rc.pc.getPackage())#/index.cfm?#HTMLEditFormat(rc.pc.getPackage())#action=public:main.viewavailableevents&UserPasswordChangeSuccessfull=True">
					<cfcatch type="any">
						<cflocation addtoken="true" url="/plugins/#HTMLEditFormat(rc.pc.getPackage())#/index.cfm?#HTMLEditFormat(rc.pc.getPackage())#action=public:main.viewavailableevents&UserPasswordChangeSuccessfull=False">
					</cfcatch>
				</cftry>
			<cfelse>
				<cflock timeout="60" scope="SESSION" type="Exclusive">
