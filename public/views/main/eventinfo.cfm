	...
	<table class="art-article" style="width:100%;" border="1" cellpadding="1" cellspacing="1">
		<tbody>
			...
			<cfif getSelectedEvent.WebinarAvailable EQ 0>
				...
				<tbody>
				<tr>
				<td style="width: 129px;"><span style="font-weight: bold;">Location<br>of Event</span></td>
				<td style="width: 351px;"><address><strong>#getEventFacility.FacilityName#</strong><br>
				...
				<td colspan="1" rowspan="4" style="width: 479px; text-align: center; vertical-align: top;">
...
<table class="art-article" style="width:100%;" border="1" cellpadding="1" cellspacing="1">
	<tbody>
		...
		<tr>
			...
			<td colspan="3"><a href="/plugins/EventRegistration#buildURL('public:main.sendquestionform')#&EventID=#URL.EventID#" class="art-button">Send Questions</a></td>
		</tr>
		<tr align="right">
			<td colspan="4"><a href="/plugins/EventRegistration#buildURL('public:main.viewavailableevents')#" class="art-button">Return to Event Listing</a>
				<cfif getSelectedEvent.AcceptRegistrations EQ 1>
					<cfif DateDiff("d", Now(), getSelectedEvent.Registration_Deadline) GTE 0>
						<cfif Variables.SeatsLeft GT 0>
							...
							<cfelse>
								<a href="/index.cfm?EventRegistrationaction=public:registerevent.default&EventID=#URL.EventID#" class="art-button">Register</a>
							</cfif>
						</cfif>
					</cfif>
				</cfif>
