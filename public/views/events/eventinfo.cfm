							...
							<article class="art-post art-article">
								<div class="art-block clearfix">
									<div class="art-blockcontent">
										...
										<cfif not isDefined("URL.DrivingDirections") and getSelectedEvent.EventCancelled IS 0 and getSelectedEvent.Active IS 1>
											<div class="art-block clearfix">
										...
										<cfelseif not isDefined("URL.DrivingDirections") and getSelectedEvent.EventCancelled IS 1 and getSelectedEvent.Active IS 0>
											<div class="art-block clearfix">
												<div class="art-blockheader">
													<h3 class="t">Viewing Event: #getSelectedEvent.ShortTitle#</h3>
												</div>
												<div class="art-blockcontent">
													<div class="alert-box notice">
														<p>The event titled <cfoutput>#GetSelectedEvent.ShortTitle#</cfoutput> has been cancelled due to low registrations.</p>
													</div>
												</div>
											</div>
