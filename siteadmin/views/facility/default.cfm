...
<cfoutput>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			var selectedRow = 0;
			$("##jqGrid").jqGrid({
				url: "/plugins/#rc.pc.getPackage()#/siteadmin/controllers/facility.cfc?method=getAllFacilities",
			...
			$('##jqGrid').navButtonAdd('##jqGridPager',
				{
					...
					onClickButton: function(id) {
						var urlToGo = "http://" + window.location.hostname + "#cgi.script_name#" + "#cgi.path_info#?#rc.pc.getPackage()#action=siteadmin:facility.addfacility";
			...
			$('##jqGrid').navButtonAdd('##jqGridPager',
				{
					...
					onClickButton: function(id) {
						if (selectedRow == 0) {
							...
							var urlToGo = "http://" + window.location.hostname + "#cgi.script_name#" + "#cgi.path_info#?#rc.pc.getPackage()#action=siteadmin:facility.editfacility&FacilityID="+ RowIDValue;
							window.open(urlToGo,"_self");
						}
						},
					position: "last"
