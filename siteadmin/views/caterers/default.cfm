...
<cfoutput>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			var selectedRow = 0;
			$("##jqGrid").jqGrid({
				url: "/plugins/#rc.pc.getPackage()#/siteadmin/controllers/caterers.cfc?method=getAllCaterers",
			...
			$('##jqGrid').navButtonAdd('##jqGridPager',
				{
					...
					onClickButton: function(id) {
						var urlToGo = "http://" + window.location.hostname + "#cgi.script_name#" + "#cgi.path_info#?#rc.pc.getPackage()#action=siteadmin:caterers.addcaterer";
			...
			$('##jqGrid').navButtonAdd('##jqGridPager',
				{
					...
					onClickButton: function(id) {
						if (selectedRow == 0) {
							...
							var urlToGo = "http://" + window.location.hostname + "#cgi.script_name#" + "#cgi.path_info#?#rc.pc.getPackage()#action=siteadmin:caterers.editcaterer&CatererID="+ RowIDValue;
							window.open(urlToGo,"_self");
						}
						},
					position: "last"
