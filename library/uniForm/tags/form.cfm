...
<cfscript>
	...
	_config.uniformJS = "#attributes.commonassetsPath#js/uni-form.jquery.js";
	_config.validationJS = "https://ajax.microsoft.com/ajax/jquery.validate/1.7/jquery.validate.min.js";
	_config.inputJS = "#attributes.commonassetsPath#js/jquery.field-0.9.3.min.js";
	_config.dateCSS = "#attributes.commonassetsPath#css/datepick/jquery.datepick.css";
	_config.dateJS = "#attributes.commonassetsPath#js/jquery.datepick-3.7.5.min.js";
	_config.timeCSS = "#attributes.commonassetsPath#css/jquery.timeentry.css";
	_config.timeJS = "#attributes.commonassetsPath#js/jquery.timeentry-1.4.6.min.js";
	_config.jquiTimeJS = "#attributes.commonassetsPath#js/jquery.timepicker.addon-0.9.1.min.js";
	_config.maskJS = "#attributes.commonassetsPath#js/jquery.maskedinput-1.3.1.min.js";
	_config.textareaJS = "#attributes.commonassetsPath#js/jquery.elastic-1.6.10.min.js";
	_config.ratingCSS = "#attributes.commonassetsPath#css/jquery.rating.css";
	_config.ratingJS = "#attributes.commonassetsPath#js/jquery.rating-3.12.min.js";
</cfscript>
