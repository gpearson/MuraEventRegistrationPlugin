...
You have been registered for #getRegistrationInfo.ShortTitle# (#DateFormat(getRegistrationInfo.EventDate, "mm/dd/yyyy")#) through the #rc.$.siteConfig('site')#. Attached is a PDF Document with your event confirmation for your records. PGP Certiciates (if available) will be issued electronically after the event.
...
Note: Replies to this automated email address are not monitored by staff. If you have questions or issues contact #rc.$.siteConfig('ContactName')# at #rc.$.siteConfig('ContactEmail')# or call #rc.$.siteConfig('ContactPhone')#
	...
	<html><body>
		<table border="0" align="center" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr><td Style="Font-Family: Arial; Font-Size: 12px; Font-Weight: Normal; Color: Black;">You have been registered for #getRegistrationInfo.ShortTitle# (#DateFormat(getRegistrationInfo.EventDate, "mm/dd/yyyy")#) through the #rc.$.siteConfig('site')#. Attached is a PDF Document with your event confirmation for your records. PGP Certiciates (if available) will be issued electronically after the event.<br><br><br>Note: Replies to this automated email address are not monitored by staff. If you have questions or issues contact #rc.$.siteConfig('ContactName')# at #rc.$.siteConfig('ContactEmail')# or call #rc.$.siteConfig('ContactPhone')#</a></td></tr>
			<tr><td Style="Font-Family: Arial; Font-Size: 12px; Font-Weight: Normal; Color: Black;">&nbsp;</td></tr>
		</table>
	</body></html>
	</cfmailpart>
