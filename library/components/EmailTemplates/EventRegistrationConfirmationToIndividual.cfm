...
You have been registered for #getEvent.ShortTitle# (#DateFormat(getEvent.EventDate, "mm/dd/yyyy")#) through the #rc.$.siteConfig('site')# event registration system. Attached is a PDF Document with your event confirmation for your records. PGP Certiciates (if available) will be issued electronically after the event.
