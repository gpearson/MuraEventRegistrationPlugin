...
APP_ID = "923408481055376";
SECRET_KEY = "95ed34b87333b62d01ef326848ae89fd";

SCOPE = "publish_actions,publish_pages,public_profile,user_friends,email";
...
if (APP_ID is "" or SECRET_KEY is "") {
	...
	if (facebookApp.isInFacebook = True) {
		WriteDump("Is In Facebook");
	} else {
		WriteDump("Is Not In Facebook");
	}
