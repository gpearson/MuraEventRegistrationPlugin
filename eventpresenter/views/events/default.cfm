			...
			<table class="table table-striped">
				...
				<tbody>
					<cfloop query="Session.getAllEvents">
						...
						<td>
							<a href="#buildURL('eventpresenter:events.geteventinfo')#&EventID=#Session.getAllEvents.TContent_ID#" class="btn btn-primary btn-small BtnSameSize"><small>Info</small></a>
							<cfif getRegisteredParticipantsForEvent.RecordCount><a href="#buildURL('eventpresenter:events.emailparticipants')#&EventID=#Session.getAllEvents.TContent_ID#&EmailType=EmailRegistered" class="btn btn-primary btn-small BtnSameSize"><small>Email Registered</small></a><cfelse><button type="button" class="btn btn-secondary btn-small BtnSameSize"><small>Email Registered</small></button></cfif>
							<cfif getAttendedParticipantsForEvent.RecordCount><a href="#buildURL('eventpresenter:events.emailparticipants')#&EventID=#Session.getAllEvents.TContent_ID#&EmailType=EmailAttended" class="btn btn-primary btn-small BtnSameSize"><small>Email Attended</small></a><cfelse><button type="button" class="btn btn-secondary btn-small BtnSameSize"><small>Email Attended</small></button></cfif>
							<cfif getRegisteredParticipantsForEvent.RecordCount><a href="#buildURL('eventpresenter:events.signinsheet')#&EventID=#Session.getAllEvents.TContent_ID#" class="btn btn-primary btn-small BtnSameSize"><small>Sign-In Sheet</small></a><cfelse><button type="button" class="btn btn-secondary btn-small BtnSameSize"><small>Sign-In Sheet</small></button></cfif>
							<cfif getRegisteredParticipantsForEvent.RecordCount><a href="#buildURL('eventpresenter:events.generatenametags')#&EventID=#Session.getAllEvents.TContent_ID#" class="btn btn-primary btn-small BtnSameSize"><small>Name Tags</small></a><cfelse><button type="button" class="btn btn-secondary btn-small BtnSameSize"><small>Name Tags</small></button></cfif>
							<a href="#buildURL('eventpresenter:events.eventdocs')#&EventID=#Session.getAllEvents.TContent_ID#" class="btn btn-primary btn-small BtnSameSize"><small>Event Documents</small></a>
							<a href="#buildURL('eventpresenter:events.eventweblinks')#&EventID=#Session.getAllEvents.TContent_ID#" class="btn btn-primary btn-small BtnSameSize"><small>Event Web Links</small></a><br>
						</td>
					</tr>
					</cfloop>
				</tbody>
