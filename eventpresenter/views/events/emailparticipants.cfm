...
<cfoutput>
	...
	<cfif not isDefined("URL.FormRetry")>
		<cfform action="#Variables.newurl#=eventpresenter:events.emailparticipants&EventID=#URL.EventID#&EmailType=#URL.EmailType#" method="post" id="AddEvent" class="form-horizontal">
