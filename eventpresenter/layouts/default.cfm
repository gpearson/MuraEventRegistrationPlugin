							...
							<div class="row">
								<div class="col-md-9">
									<ul id="navPrimary" class="nav navbar-nav">
										<li class="<cfif URL[Variables.Framework.Action] CONTAINS 'eventpresenter:main'>active</cfif>">
										...
										<li class="<cfif URL[Variables.Framework.Action] CONTAINS 'eventpresenter:events'>active</cfif>">
											<a href="##" class="dropdown-toggle" data-toggle="dropdown">Events Menu <b class="caret"></b></a>
											<ul class="dropdown-menu">
												<li class=""><a href="#buildURL('eventpresenter:events.default')#">List All Events</a></li>
											</ul
											>
										</li>
									</ul>
