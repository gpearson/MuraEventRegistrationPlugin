...
<cfelseif isDefined("FORM.formSubmit") and isDefined("URL.EventID") and isDefined("FORM.UserAction")>
	...
	<cfswitch expression="#WebRequest.status_code#">
		...
		<cfdefaultcase>
			...
			<cfif LEN(cgi.path_info)>
				<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventpresenter:events.eventweblinks&EventID=#URL.EventID#&FormRetry=True" >
			<cfelse>
				<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventpresenter:events.eventweblinks&EventID=#URL.EventID#&FormRetry=True" >
			</cfif>
			<cflocation url="#variables.newurl#" addtoken="false">
		</cfdefaultcase>
	</cfswitch>
	...
	<cfif LEN(cgi.path_info)>
		<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventpresenter:events.eventweblinks&EventID=#URL.EventID#&UserAction=LinkUploaded&Successful=True" >
	<cfelse>
		<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventpresenter:events.eventweblinks&EventID=#URL.EventID#&UserAction=LinkUploaded&Successful=True">
	</cfif>
	<cflocation url="#variables.newurl#" addtoken="false">
