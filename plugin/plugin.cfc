...
component persistent="false" accessors="true" output="false" extends="mura.plugin.plugincfc" {
	...
	public void function install() {
	    ...
	    dbFacility.setTable('p_EventRegistration_Facility')
		    ...
		    .addColumn(column='Physical_UTCOffset',dataType='char',length='10')
		    .addColumn(column='Physical_TimeZone',dataType='char',length='50')
			.addColumn(column='MailingAddress',dataType='varchar',length='255')
			.addColumn(column='MailingCity',dataType='char',length='50')
			.addColumn(column='MailingState',dataType='char',length='2')
			.addColumn(column='MailingZipCode',dataType='char',length='5')
			.addColumn(column='MailingZip4',dataType='char',length='4')
			.addColumn(column='Mailing_USPSDeliveryPoint',dataType='varchar',length='12',nullable=true)
