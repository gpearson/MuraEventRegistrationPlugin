...
<cfscript>
	dbTableEvents.addColumn(column='TContent_ID',dataType='integer',nullable=false,autoincrement=true)
		...
		.addColumn(column='EventDate',dataType='char',length='10',nullable=false)
		.addColumn(column='EventDate1',dataType='char',length='10',nullable=true)
		.addColumn(column='EventDate2',dataType='char',length='10',nullable=true)
		.addColumn(column='EventDate3',dataType='char',length='10',nullable=true)
		.addColumn(column='EventDate4',dataType='char',length='10',nullable=true)
		.addColumn(column='EventDate5',dataType='char',length='10',nullable=true)
		.addColumn(column='EventDate6',dataType='char',length='10',nullable=true)
		...
		.addColumn(column='Registration_Deadline',dataType='char',length='10',nullable=false)
		...
		.addColumn(column='Featured_StartDate',dataType='char',length='10',nullable=true)
		.addColumn(column='Featured_EndDate',dataType='char',length='10',nullable=true)
		.addColumn(column='Featured_SortOrder',dataType='integer',nullable=false)
		.addColumn(column='EarlyBird_Available',dataType='tinyint',nullable=false,default=0)
		.addColumn(column='EarlyBird_Deadline',dataType='char',length='10',nullable=true)
...
<cfscript>
	dbTableUserRegistrations.addColumn(column='TContent_ID',dataType='integer',nullable=false,autoincrement=true)
		...
		.addColumn(column='RegistrationDate',dataType='char',length='10',nullable=false)
