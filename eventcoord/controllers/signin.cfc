	...
	<cffunction name="addattendee" returntype="any" output="false">
		...
		<cfif isDefined("FORM.formSubmit")>
					...
					<cfif ListLen(FORM.AttendeeUserID) EQ 1>
						<cftry>
							...
							<cfcatch type="database">
								<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:signin.addattendee&SuccessfullAttendeeSignin=False&EventID=#URL.EventID#" addtoken="false">
							</cfcatch>
						</cftry>
						<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:signin.addattendee&SuccessfullAttendeeSignin=True&EventID=#URL.EventID#" addtoken="false">
					<cfelse>
						...
						<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:signin.addattendee&SuccessfullAttendeeSignin=True&&MultipleAttendee=True&EventID=#URL.EventID#" addtoken="false">
					</cfif>
				<cfelse>
					<cfscript>
			...
			<cfelseif isDefined("FORM.WalkInAttendee")>
				<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:signin.walkinattendee&SiteID=#rc.$.siteConfig('siteID')#&EventID=#URL.EventID#" addtoken="false">
			</cfif>
		</cfif>
	</cffunction>
