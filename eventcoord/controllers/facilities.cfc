	...
	<cffunction name="addfacility" returntype="any" output="true">
		...
		<cfif isDefined("FORM.formSubmit") and not isDefined("FORM.ReSubmit")>
			...
			<cfif AddressGeoCoded[1].ErrorMessage NEQ "OK">
				...
				<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities.addfacility&PerformAction=ReEnterAddress&SiteID=#rc.$.siteConfig('siteID')#" addtoken="false">
			<cfelse>
				...
				<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities&UserAction=AddedFacility&SiteID=#rc.$.siteConfig('siteID')#&Successful=true" addtoken="false">
			</cfif>
				...
				<cfswitch expression="#URL.PerformAction#">
					<cfcase value="Edit">
						...
						<cfif AddressGeoCoded[1].ErrorMessage NEQ "OK">
							...
							<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities.updatefacility&PerformAction=ReEnterAddress&SiteID=#rc.$.siteConfig('siteID')#&RecNo=#getSelectedFacility.TContent_ID#" addtoken="false">
						<cfelse>
							<cfset CombinedPhysicalAddress = #AddressGeoCoded[1].AddressStreetNumber# & " " & #AddressGeoCoded[1].AddressStreetNameShort#>
							...
							<cfif UpdateInfo.NameUpdated EQ 1 OR UpdateInfo.AddressUpdated EQ 1 OR UpdateInfo.CityUpdated EQ 1 OR UpdateInfo.StateUpdated EQ 1 OR UpdateInfo.ZipCodeUpdated EQ 1 OR UpdateInfo.VoiceNumberUpdated EQ 1 OR UpdateInfo.WebsiteUpdated EQ 1 OR UpdateInfo.ContactNameUpdated EQ 1 OR UpdateInfo.ContactPhoneUpdated EQ 1 OR UpdateInfo.ContactEmailUpdated EQ 1>
								...
								<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities&UserAction=UpdatedFacility&SiteID=#rc.$.siteConfig('siteID')#&Successful=true" addtoken="false">
							</cfif>
							...
							<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities" addtoken="false">
						</cfif>
					</cfcase>
					<cfcase value="Delete">
					</cfcase>
			...
			<cfswitch expression="#URL.PerformAction#">
							...
							<cfcase value="1">
								<cftry>
									...
									<cfcatch type="any">
										...
										<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities&UserAction=ErrorDatabase&SiteID=#rc.$.siteConfig('siteID')#&FacilityID=#Form.FacilityID#&Successful=false" addtoken="false">
									</cfcatch>
								</cftry>
								<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities.managerooms&RecNo=#URL.RecNo#&Successful=true&UserAction=DeletedFacilityRoom" addtoken="false">
							</cfcase>
							<cfdefaultcase>
								<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities.managerooms&RecNo=#URL.RecNo#&Successful=false&UserAction=DeletedFacilityRoom" addtoken="false">
							</cfdefaultcase>
						</cfswitch>
					</cfif>
				</cfcase>
				<cfcase value="EditRoom">
					...
					<cfif isDefined("Variables.Temp")>
						...
						<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities.managerooms&PerformAction=CorrectUpdateErrors&FacilityID=#URL.FacilityID#&RoomID=#URL.RoomID#" addtoken="false">
					</cfif>
					<cftry>
						<cfquery name="updateFacilityRoom" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
							Update eFacilityRooms
					...
					<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities.managerooms&RecNo=#URL.RecNo#&Successful=true&UserAction=UpdatedFacilityRoom" addtoken="false">
				</cfcase>
				<cfcase value="AddRoom">
					...
					<cfif isDefined("Variables.Temp")>
						...
						<cfset Session.FormData.RoomFees = #FORM.RoomFees#>
						<cfset Session.FormData.Active = #FORM.Active#>
						<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities.managerooms&PerformAction=CorrectErrors&FacilityID=#URL.FacilityID#" addtoken="false">
					</cfif>
					<cftry>
					...
					<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities.managerooms&RecNo=#URL.RecNo#&Successful=true&UserAction=AddedFacilityRoom" addtoken="false">
				</cfcase>
				<cfcase value="CorrectErrors">
					...
					<cfif isDefined("Variables.Temp")>
						...
						<cfset Session.FormData.RoomFees = #FORM.RoomFees#>
						<cfset Session.FormData.Active = #FORM.Active#>
						<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities.managerooms&PerformAction=CorrectErrors&SiteID=#rc.$.siteConfig('siteID')#&FacilityID=#Form.FacilityID#" addtoken="false">
					</cfif>
					<cftry>
						<cfquery name="insertNewFacilityRoom" Datasource="#rc.$.globalConfig('datasource')#" username="#rc.$.globalConfig('dbusername')#" password="#rc.$.globalConfig('dbpassword')#">
							Insert into eFacilityRooms(Site_ID, Facility_ID, RoomName, Capacity, RoomFees, Active, dateCreated, lastUpdated, lastUpdateBy)
						...
						<cfcatch type="any">
							<cfset Session.ApplicationError = #cfcatch#>
							<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities&UserAction=ErrorDatabase&Successful=false" addtoken="false">
						</cfcatch>
					</cftry>
					<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities.managerooms&UserAction=AddedFacilityRoom&SiteID=#rc.$.siteConfig('siteID')#&FacilityID=#Form.FacilityID#&Successful=true" addtoken="false">
				</cfcase>
				...
				<cfcase value="CorrectUpdateErrors">
					...
					<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities.managerooms&PerformAction=Update&SiteID=#rc.$.siteConfig('siteID')#&FacilityID=#Form.FacilityID#&Successful=true" addtoken="false">
				</cfcase>
