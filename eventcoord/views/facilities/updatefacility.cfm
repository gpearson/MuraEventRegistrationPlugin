			...
			<table class="table table-striped" cellspacing="0" cellpadding="0">
				...
				<tbody>
					<cfloop query="getAllFacilities">
						...
						<td width="110"><a href="#buildURL('eventcoord:facilities.updatefacility')#&PerformAction=Edit&RecNo=#getAllFacilities.TContent_ID#" class="btn btn-small">Edit</a>&nbsp;<a href="#buildURL('eventcoord:facilities.updatefacility')#&PerformAction=Delete&RecNo=#getAllFacilities.TContent_ID#" class="btn btn-small">Delete</a></td>
						</tr>
					</cfloop>
				</tbody>
			</table>
...
<cfelseif isDefined("URL.PerformAction")>
	<cfif not isNumeric(URL.RecNo)><cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities" addtoken="false"></cfif>
	<cfswitch expression="#URL.PerformAction#">
		...
		<cfcase value="Delete">
			...
			<cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:facilities&UserAction=DeleteFacility&SiteID=#rc.$.siteConfig('siteID')#&Successful=true" addtoken="false">
		</cfcase>
	</cfswitch>
</cfif>