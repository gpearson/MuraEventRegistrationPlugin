		...
		<div class="art-blockcontent">
			<table class="art-article" style="width:100%;">
				...
				<cfif getAllFacilities.RecordCount>
					<tfoot>
						<tr>
							<td colspan="6">Add a new Facility for an upcoming event that is not listed above by clicking <a href="#buildURL('eventcoord:facilities.addfacility')#" class="art-button">here</a></td>
						</tr>
					</tfoot>
					<tbody>
						<cfloop query="getAllFacilities">
							<tr bgcolor="###iif(currentrow MOD 2,DE('ffffff'),DE('efefef'))#">
								...
								<td><a href="#buildURL('eventcoord:facilities.updatefacility')#&PerformAction=Edit&RecNo=#getAllFacilities.TContent_ID#" class="art-button">Update</a>&nbsp;&nbsp;<a href="#buildURL('eventcoord:facilities.updatefacility')#&PerformAction=Delete&RecNo=#getAllFacilities.TContent_ID#" class="art-button">D</a>&nbsp;&nbsp;<a href="#buildURL('eventcoord:facilities.managerooms')#&RecNo=#getAllFacilities.TContent_ID#" class="art-button">Rooms</a></td>
							</tr>
						</cfloop>
					</tbody>
				<cfelse>
					<tbody>
						<tr>
							<td colspan="6"><div align="center" class="alert-box notice">No Facilities are located within the database Please click <a href="#buildURL('eventcoord:facilities.addfacility')#" class="art-button">here</a> to add one.</div></td>
						</tr>
					</tbody>
				</cfif>
			</table>
