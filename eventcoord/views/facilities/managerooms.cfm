	...
	<cfif not isDefined("URL.PerformAction")>
		...
		<cfoutput>
			...
			<div class="art-postmetadataheader">
				<h2 class="art-postheader"><span class="art-postheadericon">Facility Name: #getFacility.FacilityName#</span></h2>
			</div>
			...
			<cfif getFacilityRooms.RecordCount>
				<tfoot>
					<tr>
						<td colspan="6">Add a new room within the facility that is not listed above by clicking <a href="#buildURL('eventcoord:facilities.managerooms')#&PerformAction=AddRoom&RecNo=#getFacility.TContent_ID#" class="art-button">here</a> <strong>or</strong> you can return to the listing of facilities by clicking <a href="#buildURL('eventcoord:facilities')#" class="art-button">here</a></td>
					</tr>
				</tfoot>
				<tbody>
					<cfloop query="getFacilityRooms">
						<tr bgcolor="###iif(currentrow MOD 2,DE('ffffff'),DE('efefef'))#">
							...
							<td><a href="#buildURL('eventcoord:facilities.managerooms')#&PerformAction=EditRoom&RecNo=#getFacility.TContent_ID#&RoomRecNo=#getFacilityRooms.TContent_ID#" class="art-button">Edit</a>&nbsp;&nbsp;<a href="#buildURL('eventcoord:facilities.managerooms')#&PerformAction=DeleteRoom&RecNo=#getFacility.TContent_ID#&RoomRecNo=#getFacilityRooms.TContent_ID#" class="art-button">D</a></td>
						</tr>
					</cfloop>
				</tbody>
			<cfelse>
				<tbody>
					<tr>
						<td colspan="6"><div align="center" class="alert-box notice">No rooms within the facility were located in the database Please click <a href="#buildURL('eventcoord:facilities.managerooms')#&PerformAction=AddRoom&RecNo=#getFacility.TContent_ID#" class="art-button">here</a> to add one.</div></td>
					</tr>
				</tbody>
			</cfif>
		</table></cfoutput>
