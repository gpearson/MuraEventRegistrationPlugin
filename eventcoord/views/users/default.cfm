		...
		<cfif getAllUsers.RecordCount>
			...
			<tbody>
				<cfloop query="getAllUsers">
					...
					<td><a href="#buildURL('eventcoord:users.updateuser')#&PerformAction=Edit&RecNo=#getAllUsers.UserID#" class="art-button">U</a>&nbsp;<a href="#buildURL('eventcoord:users.updateuser')#&PerformAction=Delete&RecNo=#getAllUsers.UserID#" class="art-button">D</a>&nbsp;<a href="#buildURL('eventcoord:users.updateuser')#&PerformAction=LoginUser&RecNo=#getAllUsers.UserID#" class="art-button">L</a>&nbsp;<a href="#buildURL('eventcoord:users.updateuser')#&PerformAction=ChangePassword&RecNo=#getAllUsers.UserID#" class="art-button">P</a></td>
					</tr>
				</cfloop>
			</tbody>
		<cfelse>
