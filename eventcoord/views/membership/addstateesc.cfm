		...
		<div class="panel panel-default">
			<cfform action="" method="post" id="AddEvent" class="form-horizontal">
				...
				<div class="panel-body">
					<fieldset>
						<legend><h2>Add State Educational Service Center/Agency</h2></legend>
					</fieldset>
				...
				<div class="panel-footer">
					...
					<cfinput type="Submit" name="UserAction" class="btn btn-primary pull-right" value="Add State ESC Information"><br /><br />
				</div>
			</cfform>
		</div>
