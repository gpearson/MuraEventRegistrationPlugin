...
<cfif not isDefined("URL.OrgID")><cflocation url="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:membership&SiteID=#rc.$.siteConfig('siteID')#" addtoken="false"></cfif>
...
<cfoutput>
	<h2>DeActivate Member Organization</h2>
	...
	<uForm:form action="" method="Post" id="DeActivateOrganization" errors="#Session.FormErrors#" errorMessagePlacement="both"
		...
		submitValue="DeActivate Organization" loadValidation="true" loadMaskUI="true" loadDateUI="true"
		loadTimeUI="true">
