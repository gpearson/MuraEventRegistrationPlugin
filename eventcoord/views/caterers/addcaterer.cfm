			...
			<cfform action="" method="post" id="AddEvent" class="form-horizontal">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="BusinessName" name="BusinessName" required="yes"></div>
					</div>
					<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-9"><textarea name="PaymentTerms" id="PaymentTerms" class="form-control" ></textarea></div>
					</div>
					<div class="form-group">
						<label for="DeliveryInfo" class="col-lg-3 col-md-3">Delivery Information:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><textarea name="DeliveryInfo" id="DeliveryInfo" class="form-control" ></textarea></div>
					</div>
					<div class="form-group">
						<label for="GuaranteeInformation" class="col-lg-3 col-md-3">Guarantee Information:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><textarea name="GuaranteeInformation" id="GuaranteeInformation" class="form-control" ></textarea></div>
					</div>
					<div class="form-group">
						<label for="AdditionalNotes" class="col-lg-3 col-md-3">Additional Notes:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><textarea name="AdditionalNotes" id="AdditionalNotes" class="form-control" ></textarea></div>
					</div>
				</div>
				<div class="panel-footer">
					<cfinput type="Submit" name="UserAction" class="btn btn-primary pull-left" value="Back to Main Menu">
					<cfinput type="Submit" name="UserAction" class="btn btn-primary pull-right" value="Add Caterer"><br /><br />
				</div>
			</cfform>
		</div>
