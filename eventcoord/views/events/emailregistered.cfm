									...
									<tbody>
										<cfloop query="#Session.EventDocuments#">
											<tr>
												...
												<td><a href="#Session.WebEventDirectory##Session.EventDocuments.name#" class="btn btn-primary btn-small" target="_blank">View</a><a href="#CGI.Script_name##CGI.path_info#?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:events.emailregistered&EventID=#URL.EventID#&UserAction=DeleteEventDocument&DocumentName=#HTMLEditFormat(Session.EventDocuments.name)#" class="btn btn-primary btn-small" target="_blank">Delete</a></td>
											</tr>
										</cfloop>
									</tbody>
								</table>
