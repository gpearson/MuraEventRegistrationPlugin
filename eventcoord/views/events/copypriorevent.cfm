...
<cfoutput>
	<h2>Copying Workshop/Event: #Session.UserSuppliedInfo.ShortTitle#</h2>
	<div class="alert-box notice">Please click the button below to copy this event to a new event. </div>
	<hr>
	<uForm:form action="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:events.copypriorevent&compactDisplay=false&EventID=#URL.EventID#&EventStatus=CopyEvent" method="Post" id="CopyEvent" errors="#Session.FormErrors#" errorMessagePlacement="both"
