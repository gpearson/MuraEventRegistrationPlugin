...
<cfoutput>
	...
	<uForm:form action="" method="Post" id="UpdateEvent" errors="#Session.FormErrors#" errorMessagePlacement="both"
		...
		<uForm:fieldset legend="Event Date and Time  <a href='#buildURL('eventcoord:events.updateevent_datetime')#' class='ui-icon ui-icon-pencil'></a>">
		...
		<uForm:fieldset legend="Event Description  <a href='#buildURL('eventcoord:events.updateevent_description')#' class='ui-icon ui-icon-pencil'></a>">
		...
		<uForm:fieldset legend="Event Details  <a href='#buildURL('eventcoord:events.updateevent_details')#' class='ui-icon ui-icon-pencil'></a>">
		...
		<uForm:fieldset legend="Event Speaker(s)  <a href='#buildURL('eventcoord:events.updateevent_presenter')#' class='ui-icon ui-icon-pencil'></a>">
		...
		<uForm:fieldset legend="Event Pricing  <a href='#buildURL('eventcoord:events.updateevent_pricing')#' class='ui-icon ui-icon-pencil'></a>">
		...
		<uForm:fieldset legend="Event Special Pricing Information  <a href='#buildURL('eventcoord:events.updateevent_specialprice')#' class='ui-icon ui-icon-pencil'></a>">
		...
		<uForm:fieldset legend="Event Featured  <a href='#buildURL('eventcoord:events.updateevent_featured')#' class='ui-icon ui-icon-pencil'></a>">
		...
		<uForm:fieldset legend="Event Early Bird Information  <a href='#buildURL('eventcoord:events.updateevent_earlybirdinfo')#' class='ui-icon ui-icon-pencil'></a>">
		...
		<uForm:fieldset legend="Professional Growth Points Information  <a href='#buildURL('eventcoord:events.updateevent_pgppoints')#' class='ui-icon ui-icon-pencil'></a>">
		...
		<uForm:fieldset legend="Event Meal Information  <a href='#buildURL('eventcoord:events.updateevent_mealinfo')#' class='ui-icon ui-icon-pencil'></a>">
		...
		<uForm:fieldset legend="Video Conferencing Information  <a href='#buildURL('eventcoord:events.updateevent_ivcinfo')#' class='ui-icon ui-icon-pencil'></a>">
		...
		<uForm:fieldset legend="Facility Room Information  <a href='#buildURL('eventcoord:events.updateevent_facilityinfo')#' class='ui-icon ui-icon-pencil'></a>">
