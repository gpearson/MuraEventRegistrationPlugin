...
<cfoutput>
	<h2>Cancelling Workshop/Event: #Session.UserSuppliedInfo.ShortTitle#</h2>
	<div class="alert-box notice">Please click the button below to cancel this event and notify anyone who is registered for the event.</div>
	<hr>
	<uForm:form action="?#HTMLEditFormat(rc.pc.getPackage())#action=eventcoord:events.cancelevent&compactDisplay=false&EventID=#URL.EventID#&EventStatus=CancelEvent" method="Post" id="CancelEvent" errors="#Session.FormErrors#" errorMessagePlacement="both"
