				...
				<div class="panel-body">
					...
					<cfif Session.UserSuppliedInfo.ViewSpecialPricing EQ 1 and Session.UserSuppliedInfo.WebinarEvent EQ 0>
						<div class="form-group">
							...
							<div class="col-sm-8"><textarea name="SpecialPriceRequirements" id="SpecialPriceRequirements" class="form-control">#Session.UserSuppliedInfo.SpecialPriceRequirements#</textarea><span id="SpecialPricingRequirementsCharacters"></span> Characters</div>
						</div>
						<div class="form-group">
					...
					<cfif Session.UserSuppliedInfo.AllowVideoConference EQ 1  and Session.UserSuppliedInfo.WebinarEvent EQ 0>
						<div class="form-group">
							...
							<div class="col-sm-8"><textarea name="VideoConferenceInfo" id="VideoConferenceInfo" class="form-control">#Session.UserSuppliedInfo.VideoConferenceInfo#</textarea><span id="VideoConferenceInfoCharacters"></span> Characters</div>
						</div>
						<div class="form-group">
					...
					<cfif Session.UserSuppliedInfo.WebinarEvent EQ 1>
						<div class="form-group">
							...
							<div class="col-sm-8"><textarea name="WebinarConnectWebInfo" id="WebinarConnectWebInfo" class="form-control">#Session.UserSuppliedInfo.WebinarConnectWebInfo#</textarea><span id="WebinarConnectWebInfoCharacters"></span> Characters</div>
						</div>
						<div class="form-group">
					...
					<cfelseif Session.UserSuppliedInfo.WebinarEvent EQ 0>
						...
						<div class="form-group">
							...
							<div class="col-sm-8"><cfinput type="text" class="form-control MemberCost" id="RoomMaxParticipants" name="RoomMaxParticipants" value="#Session.UserSuppliedInfo.RoomMaxParticipants#" required="yes">
							</div>
						</div>
