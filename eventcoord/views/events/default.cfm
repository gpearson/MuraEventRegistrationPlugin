							...
							<tr bgcolor="###iif(currentrow MOD 2,DE('ffffff'),DE('efefef'))#">
								...
								<td>
									...
									<cfif getAttendedParticipantsForEvent.RecordCount and getAvailableEvents.PGPAvailable EQ 1>
										...
										&nbsp;&nbsp;<a href="#buildURL('eventcoord:events.enterexpenses')#&EventID=#getAvailableEvents.TContent_ID#" class="art-button">Enter Event Expenses</a><br />
									...
									<cfif getEventExpenses.RecordCount>
										&nbsp;&nbsp;<a href="#buildURL('eventcoord:events.generateprofitlossreport')#&EventID=#getAvailableEvents.TContent_ID#" class="art-button">Generate Profit/Loss Report</a><br />
									</cfif>
