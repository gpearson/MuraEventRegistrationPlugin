			...
			<cfform action="" method="post" id="AddEvent" class="form-horizontal">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label for="FacilityName" class="col-lg-3 col-md-3">Facility Name:&nbsp;<span style="Color: Red;" class="glyphicon glyphicon-star"></label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="FacilityName" name="FacilityName" value="#Session.getSelectedFacility.FacilityName#" required="yes"></div>
					</div>
					<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="PhysicalAddress" name="PhysicalAddress" value="#Session.getSelectedFacility.Physical_Address#" required="yes"></div>
					</div>
					<div class="form-group">
						<label for="PhysicalCity" class="col-lg-3 col-md-3">City:&nbsp;<span style="Color: Red;" class="glyphicon glyphicon-star"></label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="PhysicalCity" name="PhysicalCity" value="#Session.getSelectedFacility.Physical_City#" required="yes"></div>
					</div>
					<div class="form-group">
						<label for="PhysicalState" class="col-lg-3 col-md-3">State:&nbsp;<span style="Color: Red;" class="glyphicon glyphicon-star"></label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="PhysicalState" name="PhysicalState" value="#Session.getSelectedFacility.Physical_State#" required="yes"></div>
					</div>
					<div class="form-group">
						<label for="PhysicalZipCode" class="col-lg-3 col-md-3">ZipCode:&nbsp;<span style="Color: Red;" class="glyphicon glyphicon-star"></label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="PhysicalZipCode" name="PhysicalZipCode" value="#Session.getSelectedFacility.Physical_ZipCode#" required="yes"></div>
					</div>
					<div class="form-group">
						<label for="PrimaryVoiceNumber" class="col-lg-3 col-md-3">Voice Number:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="PrimaryVoiceNumber" name="PrimaryVoiceNumber" value="#Session.getSelectedFacility.PrimaryVoiceNumber#" required="no"></div>
					</div>
					<div class="form-group">
						<label for="BusinessWebsite" class="col-lg-3 col-md-3">Website:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="BusinessWebsite" name="BusinessWebsite" value="#Session.getSelectedFacility.BusinessWebsite#" required="NO"></div>
					</div>
					<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="ContactName" name="ContactName" value="#Session.getSelectedFacility.ContactName#" required="NO"></div>
					</div>
					<div class="form-group">
						<label for="ContactPhoneNumber" class="col-lg-3 col-md-3">Phone Number:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="ContactPhoneNumber" name="ContactPhoneNumber" value="#Session.getSelectedFacility.ContactPhoneNumber#" required="NO"></div>
					</div>
					<div class="form-group">
						<label for="ContactEmail" class="col-lg-3 col-md-3">Email Address:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="ContactEmail" name="ContactEmail" value="#Session.getSelectedFacility.ContactEmail#" required="NO"></div>
					</div>
					<div class="form-group">
						<label for="Active" class="col-lg-3 col-md-3">Active:&nbsp;<span style="Color: Red;" class="glyphicon glyphicon-star"></label>
						<div class="col-lg-9 col-md-9"><cfselect name="Active" class="form-control" Required="Yes" Multiple="No" query="YesNoQuery" value="ID" selected="#Session.getSelectedFacility.Active#" Display="OptionName" queryposition="below">
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="USPSDeliveryPoint" name="USPSDeliveryPoint" value="#Session.getSelectedFacility.Mailing_USPSDeliveryPoint#" disabled="yes"></div>
					</div>
					<div class="form-group">
						<label for="USPSCheckDigit" class="col-lg-3 col-md-3">USPS Check Digit:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="USPSCheckDigit" name="USPSCheckDigit" value="#Session.getSelectedFacility.Mailing_USPSCheckDigit#" disabled="yes"></div>
					</div>
					<div class="form-group">
						<label for="USPSCarrierRoute" class="col-lg-3 col-md-3">USPS Carrier Route:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="USPSCarrierRoute" name="USPSCarrierRoute" value="#Session.getSelectedFacility.Mailing_USPSCarrierRoute#" disabled="yes"></div>
					</div>
					<div class="form-group">
						<label for="LocationTimeZone" class="col-lg-3 col-md-3">Facility TimeZone:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="LocationTimeZone" name="LocationTimeZone" value="#Session.getSelectedFacility.Physical_TimeZone#" disabled="yes"></div>
					</div>
					<div class="form-group">
						<label for="LocationTimeOffset" class="col-lg-3 col-md-3">Facility UTC Offset:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="LocationTimeOffset" name="LocationTimeOffset" value="#Session.getSelectedFacility.Physical_UTCOffset#" disabled="yes"></div>
					</div>
					<div class="form-group">
						<label for="LocationCongressionalDistrict" class="col-lg-3 col-md-3">Facility Congressional District:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="LocationCongressionalDistrict" name="LocationCongressionalDistrict" value="#Session.getSelectedFacility.Physical_CongressionalDistrict#" disabled="yes"></div>
					</div>
					<div class="form-group">
						<label for="LocationCountyFIPS" class="col-lg-3 col-md-3">Facility County FIPS Code:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="LocationCountyFIPS" name="LocationCountyFIPS" value="#Session.getSelectedFacility.Physical_CountyFIPS#" disabled="yes"></div>
					</div>
					<div class="form-group">
						<label for="LocationDST" class="col-lg-3 col-md-3">DayLight Savings Time Observed:&nbsp;</label>
						<div class="col-lg-9 col-md-9">
							<cfif Session.getSelectedFacility.Physical_DST EQ true>
					...
					<div class="form-group" align="center">
						<div class="col-lg-12 col-md-12">
							...
							<script>
								var facilitymarker;
								var map = L.map('map');
								map.setView(new L.LatLng(#Session.getSelectedFacility.Physical_Latitude#, #Session.getSelectedFacility.Physical_Longitude#), 12);
								...
								var marker = L.marker([#Session.getSelectedFacility.Physical_Latitude#, #Session.getSelectedFacility.Physical_Longitude#], {icon: FacilityMarker}).addTo(map);
							</script>
						</div>
					</div>
				</div>
		...
		<div class="panel panel-default">
			<cfform action="" method="post" id="AddEvent" class="form-horizontal">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label for="FacilityName" class="col-lg-3 col-md-3">Business Name:&nbsp;<span style="Color: Red;" class="glyphicon glyphicon-star"></label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="FacilityName" name="FacilityName" value="#Session.FormInput.FacilityName#" required="yes"></div>
					</div>
					<fieldset>
						<legend><h2>Physical Location Information</h2></legend>
					</fieldset>
					<div class="form-group">
						<label for="PhysicalAddress" class="col-lg-3 col-md-3">Address:&nbsp;<span style="Color: Red;" class="glyphicon glyphicon-star"></label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="PhysicalAddress" name="PhysicalAddress" value="#Session.FormInput.Physical_Address#" required="yes"></div>
					</div>
					<div class="form-group">
						<label for="PhysicalCity" class="col-lg-3 col-md-3">City:&nbsp;<span style="Color: Red;" class="glyphicon glyphicon-star"></label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="PhysicalCity" name="PhysicalCity" value="#Session.FormInput.Physical_City#" required="yes"></div>
					</div>
					<div class="form-group">
						<label for="PhysicalState" class="col-lg-3 col-md-3">State:&nbsp;<span style="Color: Red;" class="glyphicon glyphicon-star"></label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="PhysicalState" name="PhysicalState" value="#Session.FormInput.Physical_State#" required="yes"></div>
					</div>
					<div class="form-group">
						<label for="PhysicalZipCode" class="col-lg-3 col-md-3">ZipCode:&nbsp;<span style="Color: Red;" class="glyphicon glyphicon-star"></label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="PhysicalZipCode" name="PhysicalZipCode" value="#Session.FormInput.Physical_ZipCode#" required="yes"></div>
					</div>
					<div class="form-group">
						<label for="PrimaryVoiceNumber" class="col-lg-3 col-md-3">Voice Number:&nbsp;</label>
