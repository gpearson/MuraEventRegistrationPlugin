			...
			<cfform action="" method="post" id="AddEvent" class="form-horizontal">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="FacilityName" name="FacilityName" required="no"></div>
					</div>
					<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="PrimaryVoiceNumber" name="PrimaryVoiceNumber" required="no"></div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="ContactName" name="ContactName" required="NO"></div>
					</div>
					<div class="form-group">
						<label for="ContactPhoneNumber" class="col-lg-3 col-md-3">Phone Number:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="ContactPhoneNumber" name="ContactPhoneNumber" required="NO"></div>
					</div>
					<div class="form-group">
						<label for="ContactEmail" class="col-lg-3 col-md-3">Email Address:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="ContactEmail" name="ContactEmail" required="NO"></div>
					</div>
					<div class="form-group">
						<label for="Active" class="col-lg-3 col-md-3">Active:&nbsp;<span style="Color: Red;" class="glyphicon glyphicon-star"></label>
						<div class="col-lg-9 col-md-9"><cfselect name="Active" class="form-control" required="no" Multiple="No" query="YesNoQuery" value="ID" Display="OptionName" queryposition="below">
			...
			<cfform action="" method="post" id="AddEvent" class="form-horizontal">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-9"><cfinput type="text" class="form-control" id="FacilityName" name="FacilityName" value="#Session.FormInput.FacilityName#" required="no"></div>
					</div>
					<fieldset>
						<legend><h2>Physical Location Information</h2></legend>
					</fieldset>
					...
					<div class="form-group">
						...
						<div class="col-lg-9 col-md-9"><textarea name="PaymentTerms" id="PaymentTerms" class="form-control" ><cfif isDefined("Session.FormInput.PaymentTerms")>#Session.FormInput.PaymentTerms#</cfif></textarea></div>
					</div>
					<div class="form-group">
						<label for="DeliveryInfo" class="col-lg-3 col-md-3">Delivery Information:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><textarea name="DeliveryInfo" id="DeliveryInfo" class="form-control" ><cfif isDefined("Session.FormInput.DeliveryInfo")>#Session.FormInput.DeliveryInfo#</cfif></textarea></div>
					</div>
					<div class="form-group">
						<label for="GuaranteeInformation" class="col-lg-3 col-md-3">Guarantee Information:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><textarea name="GuaranteeInformation" id="GuaranteeInformation" class="form-control" ><cfif isDefined("Session.FormInput.GuaranteeInformation")>#Session.FormInput.GuaranteeInformation#</cfif></textarea></div>
					</div>
					<div class="form-group">
						<label for="AdditionalNotes" class="col-lg-3 col-md-3">Additional Notes:&nbsp;</label>
						<div class="col-lg-9 col-md-9"><textarea name="AdditionalNotes" id="AdditionalNotes" class="form-control" ><cfif isDefined("Session.FormInput.AdditionalNotes")>#Session.FormInput.AdditionalNotes#</cfif></textarea></div>
					</div>
					<div class="form-group">
						<label for="Active" class="col-lg-3 col-md-3">Active:&nbsp;<span style="Color: Red;" class="glyphicon glyphicon-star"></label>
