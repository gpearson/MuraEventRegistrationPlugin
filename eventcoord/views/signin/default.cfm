				...
				<tbody>
					<cfif getEvents.RecordCount>
						<cfloop query="getEvents">
							...
							<td><a href="#buildURL('eventcoord:signin.addattendee')#&EventID=#getEvents.TContent_ID#" class="btn btn-success btn-sm">Sign In</a>
								
								<!--- <a href="#buildURL('eventcoord:users.updateuser')#&PerformAction=Edit&RecNo=#getAllUsers.UserID#" class="btn btn-warning btn-small">U</a>&nbsp;<a href="#buildURL('eventcoord:users.updateuser')#&PerformAction=Delete&RecNo=#getAllUsers.UserID#" class="btn btn-danger btn-small">D</a>&nbsp;<a href="#buildURL('eventcoord:users.updateuser')#&PerformAction=LoginUser&RecNo=#getAllUsers.UserID#" class="btn btn-success btn-small">L</a> --->
							</td>
							</tr>
						</cfloop>	
					<cfelse>
