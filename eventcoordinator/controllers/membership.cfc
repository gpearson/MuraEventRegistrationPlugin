<cfcomponent extends="controller" output="false" persistent="false" accessors="true">
	<cffunction name="default" returntype="any" output="false">
		...
		<cfquery name="getMembership" Datasource="#$.globalConfig('datasource')#" username="#$.globalConfig('dbusername')#" password="#$.globalConfig('dbpassword')#">
			Select TContent_ID, OrganizationName, OrganizationDomainName, StateDOE_IDNumber, StateDOE_ESCESAMembership, StateDOE_State, MailingAddress, MailingCity, MailingState, MailingZipCode, MailingZip4, Mailing_USPSDeliveryPoint, Mailing_USPSCheckDigit, Mailing_USPSCarrierRoute, Mailing_isAddressVerified, PhysicalAddress, PhysicalCity, PhysicalState, PhysicalZipCode, PhysicalZip4, Physical_USPSDeliveryPoint, Physical_USPSCheckDigit, Physical_USPSCarrierRoute, Physical_isAddressVerified, Physical_USPSDeliveryPoint, Physical_USPSCheckDigit, Physical_USPSCarrierRoute, Physical_Latitude, Physical_Longitude, Physical_DST, Physical_UTCOffset, Physical_TimeZone, dateCreated, lastUpdated, lastUpdateBy, lastUpdateByID, Active, GeoCode_Township, GeoCode_StateLongName, GeoCode_CountryShortName, GeoCode_Neighborhood, AccountsPayable_ContactName, AccountsPayable_EmailAddress, ReceiveInvoicesByEmail, PrimaryVoiceNumber, PrimaryFaxNumber, BusinessWebsite
