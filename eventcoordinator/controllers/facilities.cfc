		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif FORM.UserAction EQ "Back to Facility Listing">
				...
				<cfif LEN(cgi.path_info)>
					<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.default" >
				<cfelse>
					<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.default" >
				</cfif>
			...
			<cfif LEN(FORM.FacilityName) LT 5>
				...
				<cfif LEN(cgi.path_info)>
					<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.addfacility&FormRetry=True" >
				<cfelse>
					<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.addfacility&FormRetry=True" >
				</cfif>
				<cflocation url="#variables.newurl#" addtoken="false">
			</cfif>
			...
			<cfif LEN(FORM.BusinessWebsite) or LEN(FORM.PrimaryVoiceNumber) or LEN(FORM.ContactName) or LEN(FORM.ContactPhoneNumber) or LEN(FORM.ContactEmail) or LEN(FORM.AdditionalNotes)>
			...
			<cfif LEN(cgi.path_info)>
				<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.default&UserAction=FacilityAdded&Successful=True" >
			<cfelse>
				<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.default&UserAction=FacilityAdded&Successful=True">
			</cfif>
			<cflocation url="#variables.newurl#" addtoken="false">				
		</cfif>
	</cffunction>
	...
	<cffunction name="editfacility" returntype="any" output="false">
		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif LEN(FORM.FacilityName) LT 5>
				...
				<cfif LEN(cgi.path_info)>
					<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.editfacility&FormRetry=True&FacilityID=#URL.FacilityID#" >
				<cfelse>
					<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.editfacility&FormRetry=True&FacilityID=#URL.FacilityID#" >
				</cfif>
				<cflocation url="#variables.newurl#" addtoken="false">
			</cfif>
			...
			<cfif LEN(cgi.path_info)>
				<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.default&UserAction=FacilityUpdated&Successful=True" >
			<cfelse>
				<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.default&UserAction=FacilityUpdated&Successful=True" >
			</cfif>
			<cflocation url="#variables.newurl#" addtoken="false">
		</cfif>
	</cffunction>
	...
	<cffunction name="addfacilityroom" returntype="any" output="false">
		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif FORM.UserAction EQ "Back to Facility Listing">
				...
				<cfif LEN(cgi.path_info)>
					<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.editfacility&FacilityID=#URL.FacilityID#" >
				<cfelse>
					<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.editfacility&FacilityID=#URL.FacilityID#" >
				</cfif>
				<cflocation url="#variables.newurl#" addtoken="false">
			</cfif>
			<cfif LEN(FORM.RoomName) LT 5>
				...
				<cfif LEN(cgi.path_info)>
					<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.addfacilityroom&FormRetry=True&FacilityID=#URL.FacilityID#" >
				<cfelse>
					<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.addfacilityroom&FormRetry=True&FacilityID=#URL.FacilityID#" >
				</cfif>
				<cflocation url="#variables.newurl#" addtoken="false">
			</cfif>
			...
			<cfif LEN(cgi.path_info)>
				<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.editfacility&FacilityID=#URL.FacilityID#&UserAction=FacilityRoomAdded&Successful=True" >
			<cfelse>
				<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.editfacility&FacilityID=#URL.FacilityID#&UserAction=FacilityRoomAdded&Successful=True" >
			</cfif>
			<cflocation url="#variables.newurl#" addtoken="false">
		</cfif>
	</cffunction>
	...
	<cffunction name="editfacilityroom" returntype="any" output="false">
		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif LEN(FORM.RoomName) LT 5>
				...
				<cfif LEN(cgi.path_info)>
					<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.editfacilityroom&FormRetry=True&FacilityID=#URL.FacilityID#" >
				<cfelse>
					<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.editfacilityroom&FormRetry=True&FacilityID=#URL.FacilityID#" >
				</cfif>
				<cflocation url="#variables.newurl#" addtoken="false">
			</cfif>
			...
			<cfif LEN(cgi.path_info)>
				<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.editfacility&FacilityID=#URL.FacilityID#&UserAction=FacilityRoomUpdated&Successful=True" >
			<cfelse>
				<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:facilities.editfacility&FacilityID=#URL.FacilityID#&UserAction=FacilityRoomUpdated&Successful=True" >
			</cfif>
			<cflocation url="#variables.newurl#" addtoken="false">
