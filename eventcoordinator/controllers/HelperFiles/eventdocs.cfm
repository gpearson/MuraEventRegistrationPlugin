...
<cfelseif isDefined("FORM.formSubmit") and isDefined("URL.EventID") and not isDefined("URL.UserAction")>
	...
	<cfif LEN(cgi.path_info)>
		<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:events.eventdocs&EventID=#URL.EventID#&UserAction=DocumentUploaded&Successful=True" >
	<cfelse>
		<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=eventcoordinator:events.eventdocs&EventID=#URL.EventID#&UserAction=DocumentUploaded&Successful=True">
	</cfif>
	<cflocation url="#variables.newurl#" addtoken="false">
