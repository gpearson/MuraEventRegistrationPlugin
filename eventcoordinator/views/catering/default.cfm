...
<cfoutput>	    
	...
	<script type="text/javascript">
		$(document).ready(function () {
			var selectedRow = 0;
			$("##jqGrid").jqGrid({
				url: "/plugins/#Variables.Framework.Package#/eventcoordinator/controllers/catering.cfc?method=getAllCaterers",
			...
			$('##jqGrid').navButtonAdd('##jqGridPager',
				{
					...
					onClickButton: function(id) {
						var urlToGo = "http://" + window.location.hostname + "#cgi.script_name#" + "#cgi.path_info#?#rc.pc.getPackage()#action=eventcoordinator:catering.addcaterer";
			...
			$('##jqGrid').navButtonAdd('##jqGridPager',
				{
					...
					onClickButton: function(id) {
						if (selectedRow == 0) {
							...
							var urlToGo = "http://" + window.location.hostname + "#cgi.script_name#" + "#cgi.path_info#?#rc.pc.getPackage()#action=eventcoordinator:catering.editcaterer&CatererID="+ RowIDValue;
							window.open(urlToGo,"_self");
						}
						},
					position: "last"
