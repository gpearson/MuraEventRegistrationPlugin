			...
			<cfform action="" method="post" id="AddNewUser" class="form-horizontal">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-7"><cfinput type="text" class="form-control" id="OrganizationName" name="OrganizationName" required="no"></div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-7"><cfinput type="text" class="form-control" id="OrganizationDomainName" name="OrganizationDomainName" required="no"></div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-7"><cfinput type="text" class="form-control" id="PrimaryFaxNumber" name="PrimaryFaxNumber" required="no"></div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-7"><cfinput type="text" class="form-control" id="MailingAddress" name="MailingAddress" required="no"></div>
					</div>
					<div class="form-group">
						<label for="MailingCity" class="col-lg-5 col-md-5">Mailing City:&nbsp;</label>
						<div class="col-sm-7"><cfinput type="text" class="form-control" id="MailingCity" name="MailingCity" required="no"></div>
					</div>
					<div class="form-group">
						<label for="MailingState" class="col-lg-5 col-md-5">Mailing State:&nbsp;</label>
						<div class="col-sm-7"><cfinput type="text" class="form-control" id="MailingState" name="MailingState" Required="No"></div>
					</div>
					<div class="form-group">
						<label for="MailingZipCode" class="col-lg-5 col-md-5">Mailing ZipCode:&nbsp;</label>
						<div class="col-sm-7"><cfinput type="text" class="form-control" id="MailingZipCode" name="MailingZipCode" required="no"></div>
					</div>
					<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-sm-7"><cfinput type="text" class="form-control" id="APContactName" name="APContactName" Required="No"></div>
					</div>
					<div class="form-group">
						<label for="APContactEmail" class="col-lg-5 col-md-5">Contact Email:&nbsp;</label>
						<div class="col-sm-7"><cfinput type="text" class="form-control" id="APContactEmail" name="APContactEmail" required="no"></div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-7"><cfselect name="ReceiveInvoicesByEmail" class="form-control" Required="no" Multiple="No" query="YesNoQuery" value="ID" Display="OptionName" queryposition="below">
				...
				<div class="panel-footer">
					...
					<cfinput type="Submit" name="UserAction" class="btn btn-primary pull-right" value="Add New Member"><br /><br />
				</div>
			</cfform>
		</div>
