		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif FORM.UserAction EQ "Back to Catering Listing">
				...
				<cfif LEN(cgi.path_info)>
					<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=admin:catering.default" >
				<cfelse>
					<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=admin:catering.default" >
				</cfif>
			...
			<cfif LEN(FORM.FacilityName) LT 5>
				...
				<cfif LEN(cgi.path_info)>
					<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=admin:catering.addcaterer&FormRetry=True" >
				<cfelse>
					<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=admin:catering.addcaterer&FormRetry=True" >
				</cfif>
				<cflocation url="#variables.newurl#" addtoken="false">
			</cfif>
			...
			<cfif LEN(cgi.path_info)>
				<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=admin:catering.default&UserAction=CateringFacilityAdded&Successful=True" >
			<cfelse>
				<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=admin:catering.default&UserAction=CateringFacilityAdded&Successful=True">
			</cfif>
			<cflocation url="#variables.newurl#" addtoken="false">				
		</cfif>
	</cffunction>
	...
	<cffunction name="editcaterer" returntype="any" output="false">
		...
		<cfelseif isDefined("FORM.formSubmit")>
			...
			<cfif LEN(FORM.FacilityName) LT 5>
				...
				<cfif LEN(cgi.path_info)>
					<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=admin:catering.editcaterer&FormRetry=True&CatererID=#URL.CatererID#" >
				<cfelse>
					<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=admin:catering.editcaterer&FormRetry=True&CatererID=#URL.CatererID#" >
				</cfif>
				<cflocation url="#variables.newurl#" addtoken="false">
			</cfif>
			...
			<cfelse>
				<cfif Session.getSelectedCaterer.Physical_isAddressVerified EQ 0>
					<cfif Session.SiteConfigSettings.SmartyStreets_Enabled EQ true>
						<cfset GeoCodeCFC = createObject("component","plugins/#HTMLEditFormat(rc.pc.getPackage())#/library/components/SmartyStreets").init(apitoken="#Trim(Session.SiteConfigSettings.SmartyStreets_APIToken)#", apiid="#Trim(Session.SiteConfigSettings.SmartyStreets_APIID)#", verbose=true)>
						<cfscript>
							PassedAddress = { street = #FORM.PhysicalAddress#, city = #FORM.PhysicalCity#, state = #FORM.PhysicalState#, zipcode = #FORM.PhysicalZipCode# };
			...
			<cfif LEN(cgi.path_info)>
				<cfset newurl = #cgi.script_name# & #cgi.path_info# & "?" & #Session.PluginFramework.Action# & "=admin:catering.default&UserAction=CateringFacilityUpdated&Successful=True" >
			<cfelse>
				<cfset newurl = #cgi.script_name# & "?" & #Session.PluginFramework.Action# & "=admin:catering.default&UserAction=CateringFacilityUpdated&Successful=True" >
			</cfif>
			<cflocation url="#variables.newurl#" addtoken="false">
