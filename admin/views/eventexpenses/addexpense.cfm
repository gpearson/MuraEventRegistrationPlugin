	...
	<div class="art-block clearfix">
		...
		<div class="art-blockcontent">
			...
			<uForm:form action="" method="Post" id="AddExpenses" errors="#Session.FormErrors#" errorMessagePlacement="both"
				...
				submitValue="Add Expense Category" loadValidation="true" loadMaskUI="true" loadDateUI="false"
				loadTimeUI="false">
				<input type="hidden" name="SiteID" value="#rc.$.siteConfig('siteID')#">
				<input type="hidden" name="formSubmit" value="true">
				<uForm:fieldset legend="Expense Information">
					<uform:field label="Expense Name" name="ExpenseName" id="ExpenseName" isRequired="true" type="text" hint="Name of Expense that can be associated with an Event" />
