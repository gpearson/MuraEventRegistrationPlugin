...
<cfoutput>	    
	...
	<div class="panel panel-default">
		<div class="panel-heading"><h2>Available Users</h2></div>
		<div class="panel-body">
			<cfif isDefined("URL.UserAction")>
				<cfswitch expression="#URL.UserAction#">
					<cfcase value="UserAccountUpdated">
	...
	<script type="text/javascript">
		$(document).ready(function () {
			var selectedRow = 0;
			$("##jqGrid").jqGrid({
				url: "/plugins/#Variables.Framework.Package#/admin/controllers/siteconfig.cfc?method=getAllUsers",
			...
			$('##jqGrid').navButtonAdd('##jqGridPager',
				{
					...
					onClickButton: function(id) {
						var urlToGo = "http://" + window.location.hostname + "#cgi.script_name#" + "#cgi.path_info#?#rc.pc.getPackage()#action=admin:siteconfig.newuser";
			...
			$('##jqGrid').navButtonAdd('##jqGridPager',
				{
					...
					onClickButton: function(id) {
						if (selectedRow == 0) {
							...
							var urlToGo = "http://" + window.location.hostname + "#cgi.script_name#" + "#cgi.path_info#?#rc.pc.getPackage()#action=admin:siteconfig.edituser&UserID="+ RowIDValue;
							window.open(urlToGo,"_self");
						}
						},
					position: "last"
