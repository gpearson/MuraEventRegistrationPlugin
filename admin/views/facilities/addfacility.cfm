	...
	<cfif not isDefined("URL.FormRetry")>
		<div class="panel panel-default">
			<cfform action="" method="post" id="AddNewUser" class="form-horizontal">
				...
				<div class="panel-heading"><h2>Add New Event Facility</h2></div>
				<div class="panel-body">
					<div class="alert alert-info">Please complete the following information to add new event facility</div>
				...
				<div class="panel-footer">
					...
					<cfinput type="Submit" name="UserAction" class="btn btn-primary pull-right BtnSameSize" value="Add New Facility"><br /><br />
				</div>
			</cfform>
		</div>
