	...
	<cfif not isDefined("URL.FormRetry")>
		<div class="panel panel-default">
			<cfform action="" method="post" id="AddNewUser" class="form-horizontal">
				...
				<div class="panel-heading"><h2><h2>Add New Facility Room</h2></h2></div>
				...
				<div class="panel-footer">
					...
					<cfinput type="Submit" name="UserAction" class="btn btn-primary pull-right BtnSameSize" value="Update Facility Room Information"><br /><br />
				</div>
			</cfform>
		</div>
