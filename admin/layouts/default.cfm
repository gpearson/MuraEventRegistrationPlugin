...
<cfoutput>
	...
	<html lang="en">
		...
		<body id="EventRegistrationPlugin" class="home" data-spy="scroll" data-target=".subnav" data-offset="50">
									...
									<ul id="navPrimary" class="nav navbar-nav">
										<li class="active">
											...
											<ul class="dropdown-menu">
												<li class=""><a href="#buildURL('admin:main.default')#"><i class="icon-home"></i> Home</a></li>
												<li class=""><a href="#buildURL('admin:main.another')#"><i class="icon-leaf"></i> Another Page</a></li>
											</ul>
										</li>
										<li class="">
										...
										<li class="">
											...
											<ul class="dropdown-menu">
												...
												<li class=""><a href="#buildURL('admin:siteconfig.usermain')#">User Management</a></li>
											</ul>
										</li>
									</ul>
								</div>
			...
			#$.dspCarouselByFeedName(feedName='Slideshow', showCaption=true, cssID='myCarousel', size='carouselimage' , interval=5000 , autoStart=true )#
			
			<!--- 
			<cfdump var="#$.siteConfig('siteid')#">
